...
## Входные параметры  
$ProjectType = "PreProd"	                    # указываем тип  Test/PreProd/Prod
...
<# Phase 4 #> CodeDelivery     -Artifacts $Artifacts     -ClientUpdate $ClientUpdate  -stage "all"
<# Phase 5 #> WriteVersionDB
<# Phase 6 #> RemoveDescending -path "$ScriptsList\$ProjectType" # удаляем списки скриптов
